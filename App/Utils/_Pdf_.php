    ...
    public function Header()
    {
        ...
        if ($this->tplId === null) {
            if($this->CurOrientation == "L"){
                $this->setSourceFile($this->pathCertificates.'templates/letter_head_landscape.pdf');
            }else{
            $this->setSourceFile($this->pathCertificates.'templates/letter_head.pdf');
            }
