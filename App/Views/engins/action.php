    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card comman-shadow">
                ...
                <div class="card-body">
                    {% if type == 'add' %}
                    <p>Un engin représente un véhicule ou une machine du parc (camion, bulldozer, pelle...). Ses tarifs par défaut serviront lors de la création d'un contrat de location.</p>
                    {% elseif type == 'update' %}
                    <p>Le statut de l'engin (disponible, loué, en maintenance...) se gère séparément depuis sa fiche détail.</p>
                    {% else %}
                    <p>La suppression est définitive et n'est possible que si l'engin n'est plus référencé par un contrat, une maintenance ou un plein de carburant.</p>
                    {% endif %}
                </div>
            </div>
        </div>
