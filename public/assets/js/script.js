...
if($('.datatable').length>0){$('.datatable').each(function(){try{$(this).DataTable({"bFilter":true,});}catch(e){console.error('DataTable init failed for',this,e);}});}
if($('.datatables').length>0){$('.datatables').each(function(){try{$(this).DataTable({"bFilter":true,});}catch(e){console.error('DataTable init failed for',this,e);}});}
